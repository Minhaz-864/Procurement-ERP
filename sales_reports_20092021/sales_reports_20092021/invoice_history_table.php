<div class="table-responsive width-100">
    <table class="table table-striped jambo_table cursor-pointer invoice_history_table">
        <thead>
            <tr class="headings">
            ...
            if (!empty($sale_order_history_report)) {
                ...
                foreach ($sale_order_history_report as $sales_orders) {
                    ...
                    <tr class="clickable-row even pointer" data-id="" data-href="">
                        ...
                        <td class=""><?= get_amount_with_currency_name($total_amount); ?></td>
                    </tr>
                <?php }
                ?>
                <tr>
                    ...
                    <td></td>
                    <td></td>
                    <td><strong><?= get_amount_with_currency_name($grand_total_amount); ?></strong></td>
                </tr>
            <?php }
            ?>
