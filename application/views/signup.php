...
<head>
	...
	<title>Btrac CPU Procurement-Report Portal Signup</title>
...
<body>
	<div class="row">
			<h2 align="center">Btrac Report Portal</h2>
	<hr />
...
<?php echo form_input(['name'=>'mobileno','id'=>'mobileno','class'=>'form-control','placeholder'=>'Enter  valid  11 digit mobile number','value'=>set_value('mobileno')]);?>
